          ...
          >
            {[...categories, ...categories].map((category, index) => (
              <div key={index} className="flex-none w-48">
                <Link to={category.link} className="flex flex-col items-center p-6 rounded-xl hover:bg-neutral-800 transition-colors cursor-pointer border border-neutral-800 bg-neutral-900 group">
